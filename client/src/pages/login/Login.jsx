            ...
            <div className='w-full p-6 rounded-lg shadow-md bg-white bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-between mt-2">
                        <Link  onClick={() => toast.info("This feature is not available yet.", { position: "top-center" })} className="text-sm hover:underline hover:text-black text-white ">Forgot Password?</Link>
                    </div>
                ...
                <button onClick={() => toast.info("Google Sign-In is not available yet.", { position: "top-center" })} className="btn btn-sm btn-outline border-white text-white hover:bg-white hover:text-black w-full mt-3 h-10 flex items-center justify-center gap-2">
